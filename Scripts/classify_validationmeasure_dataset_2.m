...
S.feat_filepath = [ pathappend 'SpatialAttention_Drowsiness/microMeasuresAlertness_Neuroimage2018/Scripts/features/'];
S.feat_filename = ['feat_128channel.mat'];
...
S.validation_filepath = [ pathappend 'SpatialAttention_Drowsiness/microMeasuresAlertness_Neuroimage2018/Scripts/validation/'];
S.validation_filename = ['external_train_64.mat'];
...
S.validation_filename = ['external_test_64.mat'];
