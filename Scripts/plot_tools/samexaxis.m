...
Args=struct('YAxisLocation','left','XAxisLocation','bottom','Box','off','XLim',[],'XTick',[],'XTickLabel',[],'XMinorTick',[],'YLabelDistance',1.4,'ABC',false,'Join',false,'YTickAntiClash',false); 
